                        ...
                        <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div class="page_title_right">
                                <ol class="breadcrumb page_bradcam mb-0">
                                    <li class="breadcrumb-item"><input value="Done" type="sumit" class="btn btn-success"></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table lms_table_active3 ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> <i class=" ti-notepad"> </i> Hello nice blog i like it</td>
                                                    <td>
                                                        <select class="" id="inputGroupSelect01" name="cat_name">
                    ...
                    <div class="col-lg-12">
                        <div class="footer_iner text-center">
                            <p>2020 © Influence - Designed by
                                <a href="#"> <i class="ti-heart"></i> </a><a href="#">
                                    DashboardPack</a></p>
                        </div>
                    </div>
                </div>
